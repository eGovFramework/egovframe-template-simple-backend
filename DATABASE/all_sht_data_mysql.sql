-- 컨테이너 자동적재 호환: 전방참조 FK 비활성 + UTF-8 (mysqldump 표준 가드)
...
insert into COMTECOPSEQ(TABLE_NAME,NEXT_ID) values ('NTT_ID',11);
...
-- 사용자정보
insert into LETTNEMPLYRINFO(EMPLYR_ID,ORGNZT_ID,USER_NM,PASSWORD,EMPL_NO,IHIDNUM,SEXDSTN_CODE,BRTHDY,FXNUM,HOUSE_ADRES,PASSWORD_HINT,PASSWORD_CNSR,HOUSE_END_TELNO,AREA_NO,DETAIL_ADRES,ZIP,OFFM_TELNO,MBTLNUM,EMAIL_ADRES,OFCPS_NM,HOUSE_MIDDLE_TELNO,GROUP_ID,PSTINST_CODE,EMPLYR_STTUS_CODE,ESNTL_ID,CRTFC_DN_VALUE,SBSCRB_DE) values ('admin','ORGNZT_0000000000000','관리자','eNUY3iBsfh5B88KFcrh7lY5lRxVQmLeNTLELGw/1FUI=','','','F','','','관리자 주소','','','','','','','','','','','','GROUP_00000000000000','00000000','P','USRCNFRM_00000000000','','2011-08-02 21:01:59');
insert into LETTNEMPLYRINFO(EMPLYR_ID,ORGNZT_ID,USER_NM,PASSWORD,EMPL_NO,IHIDNUM,SEXDSTN_CODE,BRTHDY,FXNUM,HOUSE_ADRES,PASSWORD_HINT,PASSWORD_CNSR,HOUSE_END_TELNO,AREA_NO,DETAIL_ADRES,ZIP,OFFM_TELNO,MBTLNUM,EMAIL_ADRES,OFCPS_NM,HOUSE_MIDDLE_TELNO,GROUP_ID,PSTINST_CODE,EMPLYR_STTUS_CODE,ESNTL_ID,CRTFC_DN_VALUE,SBSCRB_DE) values ('user','ORGNZT_0000000000000','사용자','53SoioLuPwFkCIfI+WVlovd3UpH3SrgeXsl9Ew3oIZk=','','','F','','','사용자 주소','','','','','','','','','','','','GROUP_00000000000001','00000000','P','USRCNFRM_00000000001','','2011-08-02 21:01:59');
